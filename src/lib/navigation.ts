...
export const commandSearchItems = [
  ...
  { title: 'Clinic pipeline', href: '/clinics/pipeline', keywords: ['kanban', 'pipeline'], permission: 'clinics.view' },
  { title: 'Journey builder', href: '/training/builder', keywords: ['training', 'builder'], permission: 'training.manage' },
  { title: 'Grading review', href: '/training/grading', keywords: ['grading', 'calls'], permission: 'team.manage' },
  { title: 'Messages', href: '/team/messages', keywords: ['chat', 'internal'], permission: 'team.view' },
  { title: 'Timesheets', href: '/team/timesheets', keywords: ['clock', 'hours'], permission: 'team.view' },
  { title: 'Leave', href: '/team/leave', keywords: ['time off', 'holiday'], permission: 'team.view' },
  ...
  { title: 'Classification QA', href: '/admin/classification', keywords: ['classification', 'disputes', 'qa'], permission: 'bookings.view' },
